 ...
 * @author hamid
 */
public class AbonnemetView extends javax.swing.JFrame {
    ...
    public AbonnemetView() {
        ...
        try {
            ...
            Logger.getLogger(AbonnemetView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Information d'Abonné", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe Print", 1, 12))); // NOI18N
        ...
        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Liste des Abonnés", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe Print", 1, 12))); // NOI18N
        ...
        jPanel11.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Rechercher un  Abonné", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe Print", 1, 12))); // NOI18N
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(prenomRecherche, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            if (recupParam() != null) {
                ...
                personeToPersist.setType("Adherent");
                int res = personneService.ajouterPersonne(personeToPersist);
                //ci  l'ajout est fait avec succes  
                if (res == 1) {
                    JOptionPane.showMessageDialog(null, " Abonne ajouter avec Succes ");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            ...
            if (personneHelper.getSelected() != null) {
                ...
                int response = JOptionPane.showConfirmDialog(null, "Vous Voulez Vraiment Supprimer Cet Abonne ??", "Confirm", JOptionPane.YES_NO_OPTION);
                ...
                if (response == 0) {
                    ...
                    if (res == 1) {
                        JOptionPane.showMessageDialog(null, "Abonne supprimer avec Succes ");
                        personneHelper.remove(personneHelper.getSelected());
                    }
                }
            } else {
                JOptionPane.showMessageDialog(null, "vous selectionnez l'abonne a Supprimer !!");
            }
        } catch (Exception ex) {
            Logger.getLogger(AbonnemetView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        try {
            List<Personne> adherents = personneService.rechercheAdherent(idRecherche.getText(), nomRecherche.getText(), prenomRecherche.getText(), emailRecherche.getText(), telRecherche.getText());
            if (adherents == null) {
                personneHelper.setList(null);
                JOptionPane.showMessageDialog(null, "aucun resultat trouver ");
            } else {
                personneHelper.setList(adherents);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbonnemetView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbonnemetView().setVisible(true);
            }
        });
    }
